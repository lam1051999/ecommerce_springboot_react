              ...
              if (values.addedAddress === DEFAULT_ADDRESS) {
                if (provincesAndShopsData) {
                  ...
                  await createShipAddress({
                    ...
                    exact_address:
                      values.receiveType === ReceiveType.STORE
                        ? values.shop
                        : values.exactAddress,
                    ...
                    .then(async (shipAddressResult) => {
                      ...
                      await placeOrders({
                        ...
                        total_price: getTotalPrice(shoppingCartData.data),
                        list_products_in_order: getShoppingCartItemNormalized(
                        ...
                        .then(async () => {
                          ...
                          await changeShoppingCart({
                            amount: 0,
                            product_id: "",
                            type: ShoppingCartChangeType.RESET,
                          }).then(() =>
                ...
                await placeOrders({
                  ...
                  .then(async () => {
                    ...
                    await changeShoppingCart({
                      ...
                      product_id: "",
                      type: ShoppingCartChangeType.RESET,
                    }).then(() => navigate("/customer-infos/orders-history"));
                  })
                  .catch((error) => {
                    alert(error.data.message);
                  })
                ...
                <div className="w-[70%]">
                  <div className="bg-white rounded-xl w-full px-6 pt-3 pb-5">
                    <table className="w-full">
                      ...
                      <tbody>
                        {shoppingCartData.data.map((item, index) => (
                          <tr
                            key={item.products_entity.id}
                            style={{
                              borderBottom:
                                index !== shoppingCartData.data.length - 1
                                  ? "1px solid #d1d5db"
                                  : "",
                            }}
                          >
                            ...
                            <td className="py-6 align-top w-[40%]">
                              <div className="w-full">
                                <Link
                                  to={`/products/${item.products_entity.id}`}
                                >
                            ...
                            <td className="py-6 align-top font-semibold">
                              {formatCurrency(
                                item.products_entity.actual_price
                              )}
                            </td>
                            <td className="py-6 align-top">
                              ...
                              <button
                                ...
                                onClick={async () => {
                                  await changeShoppingCart({
                                    amount: 0,
                                    product_id: item.products_entity.id,
                                    type: ShoppingCartChangeType.REMOVE,
                                  }).unwrap();
                                }}
                              >
                        ...
                        <div className="flex items-center space-x-4 my-4">
                          <div className="flex items-center">
                            <input
                              type="radio"
                              name="receiveType"
                              value={ReceiveType.STORE}
                              onChange={handleChange}
                              checked={values.receiveType === ReceiveType.STORE}
                              id="receiveTypeStore"
                            />
                            <label
                          ...
                          <div className="flex items-center">
                            <input
                              type="radio"
                              name="receiveType"
                              value={ReceiveType.HOME}
                              onChange={handleChange}
                              checked={values.receiveType === ReceiveType.HOME}
                              id="receiveTypeHome"
                            />
                            <label
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-center pl-6 rounded-lg text-gray-700 font-bold border border-gray-300 h-[60px]">
                        <input
                          name="payment"
                          onChange={handleChange}
                          checked={values.payment === Payment.BANK}
                          value={Payment.BANK}
                          type="radio"
                          id="bankRadio"
                        />
                      ...
                      <div className="flex items-center pl-6 rounded-lg text-gray-700 font-bold border border-gray-300 h-[60px]">
                        <input
                          name="payment"
                          onChange={handleChange}
                          checked={values.payment === Payment.ONEPAY}
                          value={Payment.ONEPAY}
                          type="radio"
                          id="onpayradio"
                        />
                        <label
                      ...
                      <div className="flex items-center pl-6 rounded-lg text-gray-700 font-bold border border-gray-300 h-[60px]">
                        <input
                          name="payment"
                          onChange={handleChange}
                          checked={values.payment === Payment.PAYOO}
                          value={Payment.PAYOO}
                          type="radio"
                          id="payooradio"
                        />
                      ...
                      <div className="flex items-center pl-6 rounded-lg text-gray-700 font-bold border border-gray-300 h-[60px]">
                        <input
                          name="payment"
                          onChange={handleChange}
                          checked={values.payment === Payment.KREDIVO}
                          value={Payment.KREDIVO}
                          type="radio"
                          id="kredivoradio"
                        />
                        <label
                    ...
                    >
                      <div className="flex items-center justify-between my-4">
                        ...
                        <p className="tracking-tight text-sm font-bold">
                          {formatCurrency(getTotalPrice(shoppingCartData.data))}
                        </p>
                      </div>
